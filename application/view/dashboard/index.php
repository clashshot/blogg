                ...
                <tr>
                    ...
                    <td>
                        <div class="btn-group">
                            ...
                            <a href="<?php echo Config::get('URL'); ?>dashboard/delete/<?php echo $value->slug; ?>"><button class="btn btn-default" type="button"><i class="fa fa-fw s fa-remove"></i>Ta bort</button></a>
                        </div>
                    </td>
                </tr>
            <?php }
