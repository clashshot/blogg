 ...
 */
return array(
    "FEEDBACK_UNKNOWN_ERROR" => "Okänt error!",
    "FEEDBACK_DELETED" => "Ditt konto har tagits bort.",
    "FEEDBACK_ACCOUNT_SUSPENDED" => "Ditt konot är låst för ",
    ...
    "FEEDBACK_ACCOUNT_NOT_ACTIVATED_YET" => "Kontot är inte aktiverat. Klicka på verifierings linken i ditt mail.",
    ...
    "FEEDBACK_EMAIL_REPEAT_WRONG" => "Email och repitera email rär inte samma.",
    ...
    "FEEDBACK_EMAIL_SAME_AS_OLD_ONE" => "Denna email är samma som ditt nuvarande. Välj ett annat.",
    "FEEDBACK_EMAIL_CHANGE_SUCCESSFUL" => "Din email har ändrats.",
    "FEEDBACK_CAPTCHA_WRONG" => "Captchan var fel.",
    "FEEDBACK_PASSWORD_REPEAT_WRONG" => "Lösenord och repitera lösenord är inte samma.",
    ...
    "FEEDBACK_ACCOUNT_SUCCESSFULLY_CREATED" => "Ditt konto har skapats och vi har skickat ett mail till dig. Klicka på VERIFIERINGS LINKEN i detta mail.",
    ...
    "FEEDBACK_AVATAR_FOLDER_DOES_NOT_EXIST_OR_NOT_WRITABLE" => "Avatar mappen existerat inte eller så är den ej skriv bar. Ändra detta via chmod 775 eller 777.",
    ...
    "FEEDBACK_PASSWORD_RESET_LINK_EXPIRED" => "Din återsäll link har gått up. Var god och använd länken inom en timme.",
    "FEEDBACK_PASSWORD_RESET_COMBINATION_DOES_NOT_EXIST" => "Användarnamn/Verifikation kod kombinationen existerar inte.",
    "FEEDBACK_PASSWORD_RESET_LINK_VALID" => "Återställ lösenord liken är korrekt. Ändra lösenord nu.",
