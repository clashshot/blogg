...
class UserModel
{
    ...
    public static function getPublicProfilesOfAllUsers()
    {
        ...
        $sql = "SELECT user_id, user_name, user_email, user_active, user_has_avatar, user_deleted,user_suspension_timestamp FROM users";
    ...
    public static function getExtendedPermission($blog_id){
        ...
        if ($account_type>=3 or Session::get("user_id")==$blog_owner){
            return true;
        }else{
            return false;
        }
